...
<main>
	<div class="re-main-content">
				<h1 class="re-board-title" >레시피 수정</h1>	
				<form action='<c:url value="/recipe/modify.do" />' method="post"  enctype="multipart/form-data" onsubmit="sendForm();">
			    	...
			    	<div class="re-leftBox">
                       	<input type="file" id="thumbnailModify" name="thumbnailModify" accept=".png,.jpg,.jpeg,.jfif,.gif,.pdf,.webp,.bmp,.heic,.heif">
			    		<input type="hidden" name="thumbnail" value="${ recipe.thumbnail }">
			    		<div id="preview" style="height: 200px; margin-top: 5px;">
			    			<img src="/upload/recipe/thumbnail/${ recipe.thumbnail }" style="height: 200px;">
			    		</div>
			    	</div>
					<div class="re-rightBox">
						...
						<div class="re-mainTitleBox">
				    		...
				    		<p class="re-mainDesc"><input type="text" name="title" value="${ recipe.title }" required/></p>
				    	</div>
				    	<div class="re-mainTitleBox">
				    		<p class="re-mainTitle">재료</p>
				    		<p class="re-mainDesc"><input type="text" name="ingredient" value="${ recipe.ingredient }" required/></p>
				    	</div>
			    	</div>
			    	</div>
			    	<div class="re-mainContentBox">
			    		<p class="re-mainContent"><span>조리법</span></p>
						<textarea id="summernote" name="content">${ recipe.content }</textarea>
					</div>
					<div class="re-btnBox">
						<input type="submit" class="re-btn" value="수정">
					</div>
				</form>
			</div>
</main>
